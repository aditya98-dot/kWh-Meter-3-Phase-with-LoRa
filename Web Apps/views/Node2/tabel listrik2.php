...
<body>
  <div class="row">
    <div class="col-lg-12">
      <h1>Tabel Penggunaan Listrik<small>Node 2</small></h1>
      <ol class="breadcrumb">
                ...
                <tbody id="responsecontainer">
                  ...
                  if (isset($_POST['filter_tgl'])){
                    ...
                    if($mulai!=null || $selesai!=null){
                        ...
                        $query = mysqli_query($conn, "SELECT * FROM datalog_listrik WHERE logdate BETWEEN '$mulai' AND date_add('$selesai', INTERVAL 1 DAY) AND perangkat_id = 102 order by ID DESC");
                    } else {
                        $query = mysqli_query($conn, "SELECT * FROM datalog_listrik WHERE perangkat_id = 102");
                    }
