...
if($conn==false){
  ...
  $y_Phase_R   = mysqli_query($conn, 'SELECT frekuensi_R FROM ( SELECT * FROM datalog_listrik WHERE perangkat_id = 102 ORDER BY ID DESC LIMIT 25) Var1 ORDER BY ID ASC'); 
  $y_Phase_S   = mysqli_query($conn, 'SELECT frekuensi_S FROM ( SELECT * FROM datalog_listrik WHERE perangkat_id = 102 ORDER BY ID DESC LIMIT 25) Var1 ORDER BY ID ASC'); 
  $y_Phase_T   = mysqli_query($conn, 'SELECT frekuensi_T FROM ( SELECT * FROM datalog_listrik WHERE perangkat_id = 102 ORDER BY ID DESC LIMIT 25) Var1 ORDER BY ID ASC');
  ?>
