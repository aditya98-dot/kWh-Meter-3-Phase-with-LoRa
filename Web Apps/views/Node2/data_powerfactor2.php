...
if($conn==false){
  ...
  $y_Phase_R   = mysqli_query($conn, 'SELECT PF_R FROM ( SELECT * FROM datalog_listrik WHERE perangkat_id = 102 ORDER BY ID DESC LIMIT 25) Var1 ORDER BY ID ASC'); 
  $y_Phase_S   = mysqli_query($conn, 'SELECT PF_S FROM ( SELECT * FROM datalog_listrik WHERE perangkat_id = 102 ORDER BY ID DESC LIMIT 25) Var1 ORDER BY ID ASC'); 
  $y_Phase_T   = mysqli_query($conn, 'SELECT PF_T FROM ( SELECT * FROM datalog_listrik WHERE perangkat_id = 102 ORDER BY ID DESC LIMIT 25) Var1 ORDER BY ID ASC');
  ?>
