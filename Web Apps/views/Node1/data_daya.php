...
if($conn==false){
  ...
  $y_DayaTigaFasa = mysqli_query($conn, 'SELECT daya_Total FROM ( SELECT * FROM datalog_listrik WHERE perangkat_id = 101 ORDER BY ID DESC LIMIT 25) Var1 ORDER BY ID ASC'); 
  ?>
